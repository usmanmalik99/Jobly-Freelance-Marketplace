...
export default function Home() {
  ...
  // ✅ Redirect logged-in users away from "/" to the logged-in default page
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, (user) => {
      ...
      setAuthChecked(true); // only show public home after confirming NOT logged in
    });

    return () => unsub();
  }, [router]);

  // ✅ Prevent public home flicker while auth is being checked
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main>
        ...
        {/* ====================== Find Talent (Banner) =================== */}
        <section className="container mx-auto lg:mt-5 mt-3 py-3 md:px-5 sm:px-7 px-0">
          <div className="relative w-full sm:rounded-xl rounded-none overflow-hidden min-h-[420px] md:min-h-[520px] lg:min-h-[600px]">
            {/* IMPORTANT for older Next: layout="fill" */}
            <Image
              src="/images/girlswork.png"
              alt="For Clients banner"
              layout="fill"
              objectFit="cover"
            ...
            <div className="relative z-10 h-full xl:px-14 px-5 py-8 flex flex-col justify-between">
              <motion.h2

...
const DevIt = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Development & IT Experts for Hire in July 2022 | Jobly"/>
        ...
        <main>
           ...
           <TrustedExp
            ...
            <QuestionAsk
                ...
                thirdHeadText="What are the various ways I can connect with development and IT talent through Jobly?"
                thirdDesText="Jobly gives you flexible ways to connect with development and IT talent. You can browse service categories, review project options, message registered users, and manage work from your jobs dashboard once an order is created."

                fourHeadText="Why should I use Jobly to find talent for development and IT services?"
                fourDesText="Jobly gives you the flexibility you need to find the right talent for your development and IT projects."

                lastLeftText="Still have questions?"
                lastRightBtn={{text: "Visit our help center", link: "/help"}}
            />

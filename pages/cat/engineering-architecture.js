...
const EngineeringArchitecture = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Engineering & Architecture Experts for Hire in July 2022 | Jobly"/>
        ...
        <main>
           ...
           <TrustedExp
                ...
                skills="670 skills"
                skillsText="epresented by talent on Jobly"
                cardData={CardData}
            />
            ...
            <QuestionAsk
                ...
                thirdHeadText="What are the various ways I can connect with engineering and architecture talent through Jobly?"
